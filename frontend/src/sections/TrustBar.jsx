...
const items = [
  {
    icon: ShieldCheck,
    label: "Keine Kunden verlieren",
    sub: "Sofort-Antworten 24/7",
  },
  {
    icon: TrendingUp,
    label: "Mehr Aufträge",
    sub: "Erste Antwort gewinnt",
  },
  {
    icon: FileText,
    label: "Weniger Büroarbeit",
    sub: "Sprich statt tippen",
  },
  {
    icon: Coffee,
    label: "Mehr Freizeit",
    sub: "Feierabend zurück",
  },
  {
    icon: Wallet,
    label: "Mehr Umsatz",
    sub: "Keine Anfrage verloren",
  },
  {
    icon: Sparkles,
    label: "24/7 Verfügbar",
    sub: "Auch nach Feierabend",
  },
];
    ...
    >
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-14 md:py-20">
        <div className="mb-10 md:mb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <p className="max-w-sm text-[13px] md:text-[14px] text-black/55 leading-relaxed">
        ...
        <motion.ul
          ...
          className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-6 md:gap-x-8 gap-y-10 md:gap-y-12"
        >
          {items.map((it, i) => (
            <motion.li
              key={i}
